...
export class AddNewInventoryComponent implements OnInit {
  ...
  form1() {
    this.UserForm = this.fb.group({
      ...
      // 'weaverId':new FormControl('',Validators.required),
      // 'crdId':new FormControl ('',Validators.required)
    });
  }
  form2() {
  ...
  //       el.createdBy =this.user?.UserId
  //     })
  //     this.inventorySer.createInventoryRawMaterials(this.tasks1).subscribe((res: any) => {
